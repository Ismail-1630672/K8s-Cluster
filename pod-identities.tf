...
module "cert_manager_pod_identity" {
  ...
  cert_manager_hosted_zone_arns = ["arn:aws:route53:::hostedzone/Z083548735DYEK5QEE9NA"]
...
module "external_dns_pod_identity" {
  ...
  external_dns_hosted_zone_arns = ["arn:aws:route53:::hostedzone/Z083548735DYEK5QEE9NA"]
